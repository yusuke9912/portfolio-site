...
<main class="content">
      ...
      <article class="article">
        <div class="article-container">
          <h2 class="article-title">犬と猫を判別するLINEbot</h2>
          <div class="article-body">
            <p class="article-image small">
              <carousel :per-page="1">
                <slide><img src="@/assets/img/works/dog-cat_ai/dog-cat_ai.png" alt="LINEbotのスクリーンショット"></slide>
              </carousel>
            </p>
            <p>
            ...
            <h3>使用言語/ツール</h3>
            <ul class="skill-img">
              <li><img src="@/assets/img/skill_icon/gas.svg" alt="GASのアイコン"><span class="tooltip">GAS</span></li>
              <li><img src="@/assets/img/skill_icon/line.svg" alt="LINEのアイコン"><span class="tooltip">LINE</span></li>
            </ul>
            <h3>担当</h3>
            <p>デザイン・コーディング</p>
            <h3>デザインについて</h3>
            <p>
              Flex Message Simulatorというサービスを利用してデザインを作成しました。犬か猫かを判別するだけでなく、判別結果がどれほど確証できるのかをパーセント表示で表すようにしました。
            </p>
            <h3>コーディングについて</h3>
            <p>
